...
exports.demoSessions = exports.stateCatalog = void 0;
exports.getStateMetadataByCode = getStateMetadataByCode;
exports.getChecklistForState = getChecklistForState;
exports.createEmptyProgress = createEmptyProgress;
exports.createProfileFromOnboarding = createProfileFromOnboarding;
exports.createDemoState = createDemoState;
const baseSkills = [
    {
        id: "smooth-braking",
...
const stateMetadataByCode = Object.fromEntries(exports.stateCatalog.map((state) => [state.code, state]));
function getStateMetadataByCode(stateCode) {
    return stateMetadataByCode[stateCode] ?? stateMetadataByCode.CA;
}
function getChecklistForState(stateCode) {
    return baseSkills.map((skill) => ({
        ...skill,
        stateCode
    }));
}
function createEmptyProgress(skills) {
...
function createProfileFromOnboarding(input) {
    return {
        id: "teen-1",
        completedOnboarding: true,
...
function createDemoState() {
    ...
    return {
        ...
        coachTip: "Practice assertive but calm merges on a lower-traffic freeway entrance before repeating them in busier conditions.",
        notifications: [
